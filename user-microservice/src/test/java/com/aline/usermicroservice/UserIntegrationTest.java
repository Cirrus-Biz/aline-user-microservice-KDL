...
class UserIntegrationTest {
        ...
        class UserRegistrationTest {
                @Test
                void test_registerUser_status_isCreated_and_location_is_in_header_when_register_memberUser()
                                throws Exception {
                        // Create user first.
                ...
                @Test
                void test_registerUser_status_isCreated_and_location_is_in_header_when_register_adminUser()
                                throws Exception {
                        AdminUserRegistration adminUserRegistration = AdminUserRegistration.builder()
                                        .email("test@test.com")
                                        .firstName("Admin")
                                        .lastName("Boy")
                                        .username("adminboy")
                ...
                void test_registerUser_status_is_notFound_when_membershipId_doesNotExist() throws Exception {
                        ...
                        MemberUserRegistration memberUserRegistration = MemberUserRegistration.builder()
                                        .username("member")
                                        .password("P@ssword123")
                ...
                @Test
                void test_registerUser_status_is_conflict_when_memberUserAlreadyExists_for_membershipId()
                                throws Exception {
                        MemberUserRegistration memberUserRegistration = MemberUserRegistration.builder()
                                        .username("member")
                                        .password("P@ssword123")
                        ...
                        MemberUserRegistration alreadyExistsRegistration = MemberUserRegistration.builder()
                ...
                // For validation
                MemberUserRegistrationBuilder<? extends MemberUserRegistration, ? extends MemberUserRegistrationBuilder<?, ?>> cr; // Correct
                                                                                                                                   // registration
        ...
        // @Test
        // void
        // test_confirmUserRegistration_enables_user_when_token_is_valid_and_user_exists()
        // throws Exception {
        // // Create user first.
        // User user = createDefaultMemberUser("testboy");
        ...
        // ConfirmUserRegistration.builder()
        // .token(tokenString)
        // .build();
        ...
        class UserProfileTests {
                ...
                class UpdateUserProfileTests {
                        ...
                        @Test
                        void test_statusIsNoContent_when_profileExists_and_requestToChangeEmailIsValid()
                                        throws Exception {
                        ...
                        @Test
                        void test_statusIsNoContent_when_profileExists_and_requestToChangeLastNameIsValid()
                                        throws Exception {
                                MemberUser user = (MemberUser) createDefaultMemberUser("test_boy");
                        ...
                        @Test
                        void test_statusIsNoContent_when_profileExists_and_requestToChangeUsernameIsValid()
                                        throws Exception {
                                MemberUser user = (MemberUser) createDefaultMemberUser("test_boy");
                        ...
                        @Test
                        void test_statusIsNoContent_when_profileExists_and_requestToChangeAddressIsValid()
                                        throws Exception {
                                MemberUser user = (MemberUser) createDefaultMemberUser("test_boy");
                        ...
                        @Test
                        void test_statusIsNoContent_when_profileExists_and_requestToChangeMailingAddressIsValid()
                                        throws Exception {
                                MemberUser user = (MemberUser) createDefaultMemberUser("test_boy");
